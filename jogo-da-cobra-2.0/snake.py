...
aplle_surface = pygame.Surface((PIXEL_SIZE, PIXEL_SIZE))
aplle_surface.fill((255, 0, 0))
aplle_pos = random_on_grid()
...
while True:
    ...
    screen.blit(aplle_surface, aplle_pos)

    if collision(aplle_pos, snake_pos[0]):
